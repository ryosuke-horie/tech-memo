...
Pricing Calculator
https://calculator.aws/#/estimate?id=c28477599d26096145126c590a45189b0d39b5d0
...
先日の障害対応に関して言えば最終的にMariaDBのバックアップから復旧させることができましたが、原因の特定や修正までに5時間ほどかかっています。
対応された神尾さん、海田さん、インフラチームの人件費は高いです。

今後のバージョンアップへの追従、セキュリティ対策の適用の工数も考える必要があります。

Slackであればセキュリティ対応はSlackが行い、保守・障害対応の人件費とAWSインフラリソースへの課金は発生しません。
Slackの値段は1人あたり1050円ですが、上記を踏まえれば安いと考えられるのではないでしょうか

副次的に通知等の実装コストの削減と各種ツールとの連携が可能になるというメリットも享受できます。

以上の理由からSlackへの移行を強く提案します。
ご一考のほどよろしくお願いいたします。